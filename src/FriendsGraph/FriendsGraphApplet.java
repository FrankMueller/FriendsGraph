...
public class FriendsGraphApplet extends JApplet {

    private final static String NAME = "FriendsGraph";
    private FriendsGraphPanel drawingPanel;
    ...
    {
        return FriendsGraphApplet.class.getPackage().getImplementationVersion();
    }
    ...
    public void init() 
    {
        ...
        new Worker<Drawing>() 
        {
            ...
            public Drawing construct() throws IOException 
        	{
                ...
                {
                    NanoXMLDOMInput domi = new NanoXMLDOMInput(new FriendsGraphFactory(), new StringReader(getParameter("data")));
                ...
                else if (getParameter("datafile") != null) 
                {
                    ...
                    try 
                    {
                        NanoXMLDOMInput domi = new NanoXMLDOMInput(new FriendsGraphFactory(), in);
                        result = (Drawing) domi.readObject(0);
                    }
                    finally 
                    {
            ...
            protected void done(Drawing result)
            {
                ...
                c.removeAll();
                c.add(drawingPanel = new FriendsGraphPanel());
    ...
    private void initDrawing(Drawing d) 
    {
        ...
        DOMStorableInputOutputFormat ioFormat = new DOMStorableInputOutputFormat(new FriendsGraphFactory());
    ...
    public String getData() 
    {
        ...
        try 
        {
            NanoXMLDOMOutput domo = new NanoXMLDOMOutput(new FriendsGraphFactory());
    ...
    public static void main(String[] args) 
    {
        SwingUtilities.invokeLater(new Runnable() 
        {
            ...
            public void run() 
        	{
                JFrame f = new JFrame("Friends Graph Applet");
                f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                FriendsGraphApplet a = new FriendsGraphApplet();
